...
namespace QuizApi.Domain.Migrations
{
    ...
    [Migration("20240119174110_AZUREEEE")]
    partial class AZUREEEE
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuizApi.Domain.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("QuizApi.Domain.Entities.TestResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuizApi.Domain.Entities.TestVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("QuizApi.Domain.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("QuizApi.Domain.Entities.TestResult", b =>
                {
                    b.HasOne("QuizApi.Domain.Entities.AppUser", "AppUser")
